...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commentaires = $em->getRepository('PiBundle:Commentaire')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PiBundle\Form\CommentaireType', $commentaire);
    ...
    {
        $deleteForm = $this->createDeleteForm($commentaire);
        $editForm = $this->createForm('PiBundle\Form\CommentaireType', $commentaire);
